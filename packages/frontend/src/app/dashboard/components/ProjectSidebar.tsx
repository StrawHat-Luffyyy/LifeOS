    ...
    <aside className="w-64 shrink-0 border-r border-gray-800 bg-gray-900/40 p-4 flex flex-col gap-6">
      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          <button
            data-testid="sidebar-planner-btn"
            onClick={() => onSelectScope("planner")}
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors text-left ${
          ...
          <button
            data-testid="sidebar-agent-runs-btn"
            onClick={() => onSelectScope("agent-runs")}
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors text-left ${
